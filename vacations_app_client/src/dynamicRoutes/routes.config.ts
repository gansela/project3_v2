...
const routes = [
    ...
    { role: "guest", exact: true, isVisible: true, title: "Register", path: "/register", component: Register },
    ...
    { role: "all", exact: true, isVisible: false, title: "Home", path: "/landing", component: Landing }
]
